        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 size-full pointer-events-none md:w-3/5 xl:w-auto">
              <img src={service1} alt="Smartest AI" className="size-full object-cover md:object-right" width={800} height={730} />
            </div>
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border sm:left-1/2 sm:bottom-8 sm:-translate-x-1/2" />
          </div>
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              <div className="absolute inset-0">
                <img src={service2} alt="robot" className="size-full object-cover" width={630} height={750} />
              </div>
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((item, index) => (
                    <li key={index} className={`rounded-2xl flex items-center justify-center ${index === 2 ? 'size-[3rem] p-0.25 bg-conic-gradient  md:size-[4.5rem]' : 'flex size-10 bg-n-6 md:size-15'}`}>
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[24rem]">
                <img src={service3} alt="Scary robot" className="size-full object-cover" width={520} height={400} />
                <VideoChatMessage />
                <VideoBar />
              </div>
            </div>
